...
// Get password Recorvery Link
interface IUpdatePassword {
  email: string;
}

export const forgotPasswordLink = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { email } = req.body as IUpdatePassword;
...
export const resetPassword = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { password, confPassword } = req.body as IUpdatePassword;
